export default function Contact() {
  ...
  return (
    ...
    >
      ...
      {/* Container for paragraph + form + info */}
      <div className="max-w-6xl mx-auto flex flex-col items-center md:items-start gap-10">
        
        {/* Paragraph: order changes on medium+ screens */}
<p className="mb-10 text-center text-gray-400 text-2xl md:ml-24">
  Let's connect! Fill out the form below 👇
        ...
        <div className="flex flex-col md:flex-row w-full gap-10">
          ...
          {/* Contact Info */}
          <div className="flex-1 flex flex-col justify-center items-center md:items-start p-8 rounded-2xl text-white space-y-6 text-center md:text-left">
            {/* Email */}
